...
public class Bitstream extends DSpaceObject implements DSpaceObjectLegacySupport
{
    ...
    */
    ...
    public String getDateBitstream()
    {
        return getBitstreamService().getMetadataFirstValue(this, MetadataSchema.DC_SCHEMA, "date", "bitstream", Item.ANY);
    }

    public void setDateBitstream(Context context, String n) throws SQLException {
        getBitstreamService().setMetadataSingleValue(context, this, MetadataSchema.DC_SCHEMA, "date", "bitstream", null, n);
    }
    
    public String getPSF()
    {
        return getBitstreamService().getMetadataFirstValue(this, MetadataSchema.DC_SCHEMA, "platformSpecificFeatures", null, Item.ANY);
    }

    public void setPSF(Context context, String n) throws SQLException {
        getBitstreamService().setMetadataSingleValue(context, this, MetadataSchema.DC_SCHEMA, "platformSpecificFeatures", null, null, n);
    }   
    
    public String getPlatformType()
    {
        return getBitstreamService().getMetadataFirstValue(this, MetadataSchema.DC_SCHEMA, "platformType", null, Item.ANY);
    }

    public void setPlatformType(Context context, String n) throws SQLException {
        getBitstreamService().setMetadataSingleValue(context, this, MetadataSchema.DC_SCHEMA, "platformType", null, null, n);
    }
    
    public String getLRT() {
        return getBitstreamService().getMetadataFirstValue(this, MetadataSchema.DC_SCHEMA, "learningResourceType", null, Item.ANY);
    }

    public void setLRT(Context context, String n) throws SQLException {
        getBitstreamService().setMetadataSingleValue(context, this, MetadataSchema.DC_SCHEMA, "learningResourceType", null, null, n);
    }

    public String getVersion() {
        return getBitstreamService().getMetadataFirstValue(this, MetadataSchema.DC_SCHEMA, "coverage", "version", Item.ANY);
    }

    public void setVersion(Context context, String n) throws SQLException {
        getBitstreamService().setMetadataSingleValue(context, this, MetadataSchema.DC_SCHEMA, "coverage", "version", null, n);
    }

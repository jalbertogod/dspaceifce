...
public class DSpaceValidity implements SourceValidity
{
    ...
    public void add(Context context, DSpaceObject dso) throws SQLException
    {
        ...
        else if (dso instanceof Bitstream)
        {
            ...
            validityKey.append(bitstream.getDateBitstream());
            validityKey.append(bitstream.getPSF());
            validityKey.append(bitstream.getPlatformType());
            validityKey.append(bitstream.getLRT());
            validityKey.append(bitstream.getVersion());

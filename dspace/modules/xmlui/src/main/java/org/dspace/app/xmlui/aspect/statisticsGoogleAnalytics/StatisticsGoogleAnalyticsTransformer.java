...
public class StatisticsGoogleAnalyticsTransformer extends AbstractDSpaceTransformer {
    ...
    public void addPageMeta(PageMeta pageMeta) throws SAXException, WingException, UIException, SQLException, IOException, AuthorizeException {
        ...
        // Add javascript
        /*pageMeta.addMetadata("javascript").addContent("www.gstatic.com/charts/loader.js");*/
        pageMeta.addMetadata("javascript", "static").addContent("static/js/graphics_google.js");
    }

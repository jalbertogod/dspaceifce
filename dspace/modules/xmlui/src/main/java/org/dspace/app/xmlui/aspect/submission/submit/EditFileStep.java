...
public class EditFileStep extends AbstractStep
{
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        Composite fullDate = edit.addItem().addComposite(fieldName);
        ...
        fullDate.setHelp("Data da produção do objeto. O dia e/ou mês podem ser deixados em branco caso não seja aplicáveis.");
        ...
        DCDate d = new DCDate(bitstream.getDateBitstream());
        day.setValue("" + d.getDay());
        month.setOptionSelected(d.getMonth());
        year.setValue("" + d.getYear());
        
        Select descriptionPSF = edit.addItem().addSelect("platformSpecificFeatures");
        ...
        descriptionPSF.setOptionSelected(bitstream.getPSF());
        
        Select descriptionPT = edit.addItem().addSelect("platformType");
        descriptionPT.setLabel("Tipo de Plataforma/Finalidade");
        descriptionPT.setRequired();
        ...
        descriptionPT.setOptionSelected(bitstream.getPlatformType());
        
            
        Select descriptionLRT = edit.addItem().addSelect("learningResourceType");
        descriptionLRT.setLabel("Tipo de recurso educacional");
        descriptionLRT.setHelp("Natureza ou gênero do conteúdo");
        descriptionLRT.setRequired();
        ...
        descriptionLRT.setOptionSelected(bitstream.getLRT());
        
        Text version = edit.addItem().addText("version");
        version.setLabel("Versão");
        version.setHelp("Insira a versão do arquivo");
        version.setValue(bitstream.getVersion());

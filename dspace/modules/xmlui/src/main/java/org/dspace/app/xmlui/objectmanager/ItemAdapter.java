...
public class ItemAdapter extends AbstractAdapter
{
    ...
    url += "&isAllowed=" + isAllowed;
        ...
        if (dateBitstream != null)
        {
            attributesXLINK.put("dateBitstream", dateBitstream);
        }
        if (platformSpecificFeatures != null)
        {
            attributesXLINK.put("platformSpecificFeatures", platformSpecificFeatures);
        }
        if (platformType != null)
        {
            attributesXLINK.put("platformType", platformType);
        }
        if (learningResourceType != null)
        {
            attributesXLINK.put("learningResourceType", learningResourceType);
        }
        if (version != null)
        {
            attributesXLINK.put("version", version);
        }
